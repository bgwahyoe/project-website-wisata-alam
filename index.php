                        ...
                        <div class="row align-items-center">
                                    ...
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a href="#">pages <i class="ti-angle-down"></i></a>
                                                <ul class="submenu">
                                                        <li><a class="<?php if (isset($_GET['hal']) && $_GET['hal'] == 'destination_details') {echo 'active';} ?>" href="index.php?hal=destination_details">Destinations details</a></li>
                                                        <!-- <li><a href="elements.html">elements</a></li> -->
                                                </ul>
                                            </li>
                                            <li><a href="#">blog <i class="ti-angle-down"></i></a>
                                                <ul class="submenu">
                                                    <li><a class="<?php if (isset($_GET['hal']) && $_GET['hal'] == 'blog') {echo 'active';} ?>" href="index.php?hal=blog">blog</a></li>
                            ...
                            <div class="col-xl-4 col-lg-4 d-none d-lg-block">
                                <div class="social_wrap d-flex align-items-center justify-content-end">
                                    <div class="number">
                                        <p> <i class="fa fa-phone"></i> (+62) 895 6048 49987</p>
                                    </div>
