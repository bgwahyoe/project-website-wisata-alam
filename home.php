                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-12 col-md-12">
                            <div class="slider_text text-center">
                                ...
                                <a href="index.php?hal=travel_destination" class="boxed-btn3">Explore Now</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section_title text-center mb_70">
                        ...
                        <p>Explore the breathtaking natural wonders of Indonesia, from lush rainforests to pristine beaches.</p>
                    </div>
                </div>
            </div>
            <div class="row">
